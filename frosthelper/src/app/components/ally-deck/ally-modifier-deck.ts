...
const M_0: ModifierCard = {
  image: 'assets/monster-mod-deck/m-deck-0.png',
  triggers: [],
};

const M_PLUS_1: ModifierCard = {
  image: 'assets/monster-mod-deck/m-deck-plus-1.png',
  triggers: [],
};

const M_PLUS_2: ModifierCard = {
  image: 'assets/monster-mod-deck/m-deck-plus-2.png',
  triggers: [],
};

const M_MINUS_1: ModifierCard = {
  image: 'assets/monster-mod-deck/m-deck-minus-1.png',
  triggers: [],
};

const M_MINUS_2: ModifierCard = {
  image: 'assets/monster-mod-deck/m-deck-minus-2.png',
  triggers: [],
};

const M_MISS: ModifierCard = {
  image: 'assets/monster-mod-deck/m-deck-miss.png',
  triggers: ['miss', 'reshuffle'],
};

const M_CRIT: ModifierCard = {
  image: 'assets/monster-mod-deck/m-deck-crit.png',
  triggers: ['crit', 'reshuffle'],
};

export const M_CURSE: ModifierCard = {
  image: 'assets/monster-mod-deck/m-deck-curse.png',
  triggers: ['remove', 'miss'],
};

export const M_BLESS: ModifierCard = {
  image: 'assets/monster-mod-deck/m-deck-bless.png',
  triggers: ['remove', 'crit'],
};

export const DEFAULT_ALLY_MODIFIER_DECK: ModifierCard[] = [
